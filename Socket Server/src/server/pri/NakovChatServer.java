        ...
        while (true) {
           try {
        	   ...
        	   if(dispatchers.size()==0||dispatchers.get(dispatchers.size()-1).getPlayersCount()>=2){
        		 try{
        			 System.out.println("dispatchers.get(dispatchers.size()-1).getPlayersCount(): "+dispatchers.get(dispatchers.size()-1).getPlayersCount()+" dispatchers.size(): "+dispatchers.size());
